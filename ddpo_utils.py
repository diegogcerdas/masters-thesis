from typing import Optional, Tuple, Union, Dict, Any, Callable, List
import torch
import math
...
def get_prompt_fn(prompt_filename: str) -> Callable:
    def prompt_fn(batch_size) -> str:
        with open(prompt_filename, "r") as f:
            prompts = f.readlines()
            selection = torch.randint(0, len(prompts), (batch_size,))
            prompts = [prompts[i].strip() for i in selection]
        return prompts
