...
def build_roi_inverted_index(dataset_root: str, subject: int, hemisphere: str):
    subj_dir = os.path.join(dataset_root, f"subj{subject:02d}")
    inverted_index = {}
    for roi_class in tqdm(
        ...
        roi_map_dir = os.path.join(
            subj_dir, "roi_masks", "mapping_" + roi_class + ".npy"
        )
